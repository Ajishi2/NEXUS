...
export default function Home() {
  return (
    <main className="w-full bg-black overflow-x-hidden">
      {/* Header navigation - fixed, positioned above hero */}
      <Header />

      {/* Full-screen hero section with animated background */}
      <section className="relative h-screen w-full flex flex-col bg-black">
        ...
        <div className="flex-1 flex items-center justify-center px-4">
          <div className="flex flex-col items-center justify-center gap-8 text-center">
            ...
            {/* CTA Button */}
            <Link href="/analyzer" className="glowing-btn mt-8 inline-block">
              EXPLORE NOW
            </Link>
          </div>
        </div>
      ...
      <section className="relative py-20 px-4 md:px-8">
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="space-y-4 pb-20">
            ...
            <button className="px-8 py-4 rounded-full bg-white text-black font-bold tracking-wider hover:bg-white/90 transition-all duration-300">
              START YOUR JOURNEY
            </button>
          </div>
        </div>
